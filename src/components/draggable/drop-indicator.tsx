...
type ColorVariant = { bg: string; border: string; beforeBorder: string };
...
export function DropIndicator({
  ...
  const colorVariants: Record<string, ColorVariant> = {
    blue: { bg: "bg-blue-700", border: "border-blue-700", beforeBorder: "before:border-blue-700" },
    emerald: { bg: "bg-teal-500", border: "border-teal-500", beforeBorder: "before:border-teal-500" },
  };
    ...
    <div
      ...
      className={twMerge(
        ...
        instruction.operation === "combine" &&
          `bg-transparent inset-0 border-2 ${colorVariants[color].border} rounded-lg`,
